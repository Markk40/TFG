...
SCENARIO_PRESETS: Dict[str, Dict[str, Any]] = {
    "Baseline": {
        "base_level_multiplier": 1.0,
        "volatility_scale": 1.0,
        "checkpoint_freq": 3500,
        "checkpoint_depth": 0.75,
        "checkpoint_len": 80,
        "tail_scale": 1.0,
    },
    "Stress test": {
        ...
        "checkpoint_depth": 0.95,
        "checkpoint_len": 150,
        "tail_scale": 2.0,
    },
    "Inference": {
        "base_level_multiplier": 0.4,
        "volatility_scale": 0.5,
        "checkpoint_freq": 8000,
        "checkpoint_depth": 0.3,
        "checkpoint_len": 30,
        "tail_scale": 0.5,
    },
    "Fine-tuning": {
        "base_level_multiplier": 0.75,
        "volatility_scale": 1.5,
        "checkpoint_freq": 2000,
        "checkpoint_depth": 0.6,
        "checkpoint_len": 60,
        "tail_scale": 1.2,
    },
}
